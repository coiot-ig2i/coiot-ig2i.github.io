...
<body id="page-top" data-spy="scroll" data-target=".navbar-custom">
	...
	<section id="about" class="home-section text-center bg-white">
		...
		<div class="container service-desc">
			<div class="row">
			...
			<div class="row">
				<div class="col-sm-10 col-sm-offset-1">
					<h4>
						Nous avons besoin de vous ! Soumettez-nous vos idées de projet, <a href='#contact'>Contactez-nous</a>.
					</h4>
				</div>
			</div>
		</div>
				...
				<div class="col-sm-4 col-md-4">
					<div class="wow fadeInLeft" data-wow-delay="0.2s">
						<div class="service-box">
							...
							<div class="service-desc">
								<h5>Systèmes autonomes</h5>
								<p>Quadricoptères, drones, robots mobiles ... Autant de machines au service de l'humain. Cependant, il n'existe aucune solution efficace pour les faire communiquer et interargir ensemble; CoioT se propose de réaliser à vos côtés une étude pour palier à ce problème. Notre objectif est donc simple : faire coopérer ces systèmes.</p>
								<p><strong>Le projet Dronit, primé lors d'un StartupWeekend, se joint à nous pour vous apporter leur expertise.</strong></p>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-xs-6 col-sm-3 col-md-3">
					<div class="wow bounceInUp" data-wow-delay="0.2s">
						<div class="team boxed-grey">
							<div class="inner">
								<h5>Guillaume Carnoy</h5>
								<p class="subtitle">Chargé d'affaires</p>
								<div class="avatar">
				...
				<div class="col-xs-6 col-sm-3 col-md-3">
					<div class="wow bounceInUp" data-wow-delay="0.4s">
						<div class="team boxed-grey">
							<div class="inner">
								<h5>Julien Olivier</h5>
								<p class="subtitle">Chargé d'affaires</p>
								<div class="avatar">
									<img src="img/team/41.jpg" alt="" class="img-responsive img-circle" />
								</div>
								<div><p>Designer. Conception de systèmes et gestion de projets en domotique.</p></div>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row">
					...
					<div class="wow bounceInUp" data-wow-delay="0.5s">
						...
						<div class="team boxed-grey">
							<div class="inner">
								...
								<p class="subtitle">Chargé d'affaires</p>
								<div class="avatar">
									<img src="img/team/51.jpg" alt="" class="img-responsive img-circle" />
								</div>
								<div><p>La curiosité et la soif d'apprendre sont les moteurs de notre réussite.</p></div>
							</div>
						</div>
					</div>
				</div>
				<div class="col-xs-6 col-sm-3 col-md-3">
					<div class="wow bounceInUp" data-wow-delay="0.6s">
						...
						<div class="team boxed-grey">
							<div class="inner">
								<h5>Tony Cleenewerck</h5>
								<p class="subtitle">Responsable technique</p>
								<div class="avatar">
				...
				<div class="col-xs-6 col-sm-3 col-md-3">
					<div class="wow bounceInUp" data-wow-delay="0.7s">
						...
						<div class="team boxed-grey">
							<div class="inner">
								<h5>Remi Blaut</h5>
								<p class="subtitle">Responsable comptabilité</p>
								<div class="avatar">
			...
			<div class="row">
					...
					<div class="boxed-grey">
						...
						?>
							<div class="row">
								<div class="col-md-6">
									...
									<div class="form-group">
										...
										<select id="subject" name="subject" class="form-control" required="required">
											...
											<option value="question">Demande de renseignements complémentaires</option>
											<option value="suggestions">Suggestions</option>
											<option value="product">Idée de projet</option>
										</select>
									</div>
								</div>
								<div class="col-md-6">
								...
								<div class="col-md-12">
									<button type="submit" class="btn btn-skin pull-right" id="btnContactUs"> Envoyer le message</button>
								</div>
							</div>
						</form>
					</div>
				...
				<div class="col-lg-4">
					<div class="widget-contact">
						...
						<address>
							<strong>CoioT - PRP5</strong>
							<br/>
							13 rue Jean Souvraz
							<br/>
							62300 LENS, France
							<br/>
							<abbr title="Téléphone"><span class="glyphicon glyphicon-phone"></span></abbr> non-communiqué
						</address>
						<address>
							<strong>Email</strong>
							<br/>
							<a href="mailto:coiot@ig2i.fr">coiot@ig2i.fr</a>
						</address>	
						<address>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 col-lg-12">
					...
					<p>&copy;Copyright 2015 - CoioT. All rights reserved.</p>
				</div>
			</div>	
		</div>
	</footer>
